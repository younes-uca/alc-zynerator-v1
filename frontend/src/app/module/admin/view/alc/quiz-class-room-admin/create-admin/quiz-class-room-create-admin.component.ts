...
export class QuizClassRoomCreateAdminComponent extends AbstractCreateController<QuizClassRoomDto, QuizClassRoomCriteria, QuizClassRoomService>  implements OnInit {
