package ma.sir.alc.zynerator.converter;


import ma.sir.alc.zynerator.bean.Etablissement;
import ma.sir.alc.zynerator.dto.EtablissementDto;

import ma.sir.alc.zynerator.util.ListUtil;
import ma.sir.alc.zynerator.audit.AuditBusinessObject;
import ma.sir.alc.zynerator.bean.BusinessObject;
import ma.sir.alc.zynerator.dto.AuditBaseDto;
import ma.sir.alc.zynerator.dto.BaseDto;
import ma.sir.alc.zynerator.util.DateUtil;
import ma.sir.alc.zynerator.util.RefelexivityUtil;
import ma.sir.alc.zynerator.util.StringUtil;
import ma.sir.alc.zynerator.util.Utils;
